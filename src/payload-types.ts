...
/**
 * Append-only log of authentication events and contact form submissions.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface AuditLog {
  id: number;
  action: 'login' | 'login-failed' | 'logout' | 'forgot-password' | 'form-submission';
  user?: (number | null) | User;
  ip?: string | null;
  userAgent?: string | null;
  /**
   * Identifier of the affected resource, e.g. a form submission ID.
   */
